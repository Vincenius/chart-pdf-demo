...
function generateChartSvgString({
  data,
  ...
  y.domain([0, d3.max(data, d => d.barValue)])
  ...
  svg.selectAll('.bar')
    ...
    .attr('height', d => height - y(d.barValue))
  ...
  const lineChartData = data.map(d => ({ key: d.key, value: d.lineValue }))
...
module.exports = generateChartSvgString